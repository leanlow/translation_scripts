...
textfile4 = open(sys.argv[4]).read().splitlines()
...
for line in textfile1:
	...
	#print("go")
	txBox = slide.shapes.add_textbox(Inches(0), Inches(1.34), width, Inches(0.64))
	tf = txBox.text_frame
	p = tf.paragraphs[0]
	...
	txBox2 = slide.shapes.add_textbox(Inches(0), Inches(1.98), width, Inches(0.64))
	...
	txBox3 = slide.shapes.add_textbox(Inches(0), Inches(3.45), width, Inches(0.64))
	...
	txBox4 = slide.shapes.add_textbox(Inches(0), Inches(2.81), width, Inches(0.64))
	tf4 = txBox4.text_frame
	p4 = tf4.paragraphs[0]
	p4.alignment = PP_ALIGN.CENTER
	run4 = p4.add_run()
	run4.text = textfile4[count2]
	count2 +=1
	font4 = run4.font
	font4.name = '210 Hayanbunpil Light Bold'
	font4.size = Pt(26)
